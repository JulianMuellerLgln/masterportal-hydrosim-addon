...
`;function ve(){const a=document.createElement("style");a.textContent=be,document.head.appendChild(a);const r=document.createElement("button");r.id="hydrosim-trigger",r.title="HydroSim — Hochwassersimulation",r.innerHTML='<i class="bi bi-water"></i>',document.body.appendChild(r);const o=document.createElement("div");o.id="hydrosim-panel",o.innerHTML=ye,document.body.appendChild(o);const t=f=>document.getElementById(f),l=t("hs-draw-btn"),d=t("hs-draw-label"),M=t("hs-draw-hint"),x=t("hs-run"),k=t("hs-pause"),n=t("hs-reset"),c=t("hs-status"),i=t("hs-progress"),s=t("hs-progress-bar"),p=t("hs-volume"),y=t("hs-duration"),g=t("hs-speed"),C=t("hs-mode"),I=t("hs-mode-help"),S=t("hs-vol-val"),A=t("hs-dur-val"),F=t("hs-speed-val"),h=t("hs-measure-pump"),T=t("hs-measure-dike"),H=t("hs-measure-retention"),E=t("hs-measure-level"),q=t("hs-measure-level-val"),$=t("hs-impact-section"),B=t("hs-impact-count"),j=t("hs-impact-tbody");let U="idle",K=!0;return r.addEventListener("click",()=>{o.classList.toggle("visible")}),t("hs-close").addEventListener("click",()=>{o.classList.remove("visible")}),C.addEventListener("change",()=>{I.textContent=C.value==="auto"?"Automatik wählt den Ereignistyp anhand von Volumen und Dauer.":`Manueller Modus: ${C.options[C.selectedIndex].text}`}),p.addEventListener("input",()=>{S.textContent=Number(p.value).toLocaleString("de-DE")}),y.addEventListener("input",()=>{A.textContent=y.value}),g.addEventListener("input",()=>{F.textContent=g.value}),E.addEventListener("input",()=>{q.textContent=E.value}),{panel:o,trigger:r,getParams(){return{volumeM3:Number(p.value),durationMin:Number(y.value),durationS:Number(y.value)*60,speed:Number(g.value),mode:C.value||"auto",measures:{pump:!!h.checked,dike:!!T.checked,retention:!!H.checked,level:Number(E.value)/100}}},onDraw(f){l.addEventListener("click",f)},onRun(f){x.addEventListener("click",f)},onPause(f){k.addEventListener("click",f)},onReset(f){n.addEventListener("click",f)},setState(f){U=f,l.disabled=!K||["drawing","sampling","running"].includes(f),x.disabled=!K||!["ready","paused"].includes(f),k.disabled=f!=="running",n.disabled=f==="sampling",f==="drawing"?(d.textContent="Zeichnen…",l.classList.add("active"),M.style.display="block"):(d.textContent="Polygon zeichnen",l.classList.remove("active"),M.style.display="none"),f==="idle"&&$.classList.remove("visible"),f==="results"&&$.classList.add("visible")},setGate(f){K=!!f,this.setState(U)},setStatus(f,O="bi-info-circle"){c.innerHTML=f?`<i class="bi ${O}"></i> ${f}`:""},setProgress(f){f===null?(i.style.display="none",s.style.width="0%"):(i.style.display="block",s.style.width=`${Math.round(f*100)}%`)},setImpact(f){if(!f||f.length===0){B.textContent="0",j.innerHTML='<tr><td colspan="3" style="color:#607d8b;text-align:center">Keine Gebäude betroffen</td></tr>';return}B.textContent=f.length;const O=f[0].score;j.innerHTML=f.slice(0,10).map(_=>`<tr>
        ...
        </tr>`).join("")}}}(async function(){const r=(...e)=>console.log("[HydroSim]",...e),o=(...e)=>console.error("[HydroSim]",...e);let t=null,l=null;function d(){var e,u,b,m;return((m=(b=(u=(e=window.mapCollection)==null?void 0:e.getMap)==null?void 0:u.call(e,"3D"))==null?void 0:b.getCesiumScene)==null?void 0:m.call(b))??null}function M(){var u,b,m,v,w,P;const e=(v=(m=(b=(u=document.getElementById("masterportal-root"))==null?void 0:u.__vue_app__)==null?void 0:b.config)==null?void 0:m.globalProperties)==null?void 0:v.$store;return((P=(w=e==null?void 0:e.state)==null?void 0:w.Maps)==null?void 0:P.mode)??null}async function x(){var u,b,m,v,w,P;const e=(v=(m=(b=(u=document.getElementById("masterportal-root"))==null?void 0:u.__vue_app__)==null?void 0:b.config)==null?void 0:m.globalProperties)==null?void 0:v.$store;if(!e)return!1;if(((P=(w=e.state)==null?void 0:w.Maps)==null?void 0:P.mode)==="3D")return!0;try{return await e.dispatch("Maps/activateMap3d"),!0}catch{try{return await e.dispatch("Maps/changeMapMode","3D"),!0}catch{return!1}}}async function k(){return new Promise(e=>{const u=setInterval(()=>{window.Cesium&&d()&&(clearInterval(u),e())},500)})}try{const e=`/hydrosim.wasm?v=${Date.now()}`;let u;try{u=await WebAssembly.instantiateStreaming(fetch(e,{cache:"no-store"}),{env:{abort(b,m,v,w){o(`WASM abort at ${m}:${v}:${w}`,b)}}})}catch{const v=await(await fetch(e,{cache:"no-store"})).arrayBuffer();u=await WebAssembly.instantiate(v,{env:{abort(w,P,L,D){o(`WASM abort at ${P}:${L}:${D}`,w)}}})}t=u.instance.exports,l=t.memory,r("WASM loaded.")}catch(e){o("WASM load failed:",e)}await k();const n=ve();if(n.setState("idle"),!t){n.setStatus("WASM konnte nicht geladen werden — Simulation deaktiviert","bi-exclamation-triangle");return}let c="idle",i=null,s=null,p=null,y=null,g=null,C=0,I=0;const S=new Map,A=10,F=8e3;function h(e){c=e,n.setState(e),r("State ->",e)}function T(){if(!y){const e=d();e&&(y=ue(e))}}function H(){const e=d(),u=e==null?void 0:e.camera;if(!u||!window.Cesium)return!1;const b=window.Cesium.Cartographic.fromCartesian(u.positionWC);return Number.isFinite(b.height)&&b.height<=F}function E(){const e=H();return n.setGate(e),!e&&c==="idle"&&n.setStatus(`Für HydroSim näher heranzoomen (Kamerahöhe < ${F} m).`,"bi-zoom-in"),e&&c==="idle"&&n.setStatus("Bereit — Polygon zeichnen um zu beginnen","bi-info-circle"),e}function q(){const e=d(),u=e==null?void 0:e.camera;if(!u||!window.Cesium)return 50;const m=window.Cesium.Cartographic.fromCartesian(u.positionWC).height;return Number.isFinite(m)?m<2500?20:m<5e3?30:50:50}function $(e){return Math.max(0,Math.min(1,Number.isFinite(e)?e:0))}function B(e){if(e.mode&&e.mode!=="auto")return e.mode;const u=e.volumeM3/Math.max(60,e.durationS);return u<150?"rain":u<900?"flash":"river"}function j(e){return e==="flash"?{inflow:1.2,friction:.95}:e==="river"?{inflow:.9,friction:.85}:{inflow:1,friction:1}}async function U(e){h("sampling"),n.setStatus("Terrain wird abgetastet…","bi-hourglass-split"),n.setProgress(.05);try{const u=q();s=await ce(e,i,u,D=>n.setProgress(D*.9)),n.setProgress(1);const{heights:b,nx:m,ny:v,dx:w}=s;if(t.init(m,v,w)<0)throw new Error("WASM init failed: not enough memory for grid");l=t.memory;const L=t.scratchPtr();new Float32Array(l.buffer,L,m*v).set(b),t.setTerrain(L,m*v),setTimeout(()=>n.setProgress(null),500),h("ready"),n.setStatus(`Bereit. Grid: ${m}x${v}, dx=${w.toFixed(0)}m`,"bi-check-circle")}catch(u){o("Terrain sampling failed:",u),n.setProgress(null),h("idle"),n.setStatus("Terrain-Abfrage fehlgeschlagen: "+u.message,"bi-exclamation-triangle")}}function K(e,u,b,m,v,w){const P=e.reduce((R,Y)=>R+Y.lon,0)/e.length,L=e.reduce((R,Y)=>R+Y.lat,0)/e.length,D=111320,z=111320*Math.cos(L*Math.PI/180),V=Math.round((P-v)*z/m),ee=Math.round((L-w)*D/m),Q=e.map(R=>R.lon),X=e.map(R=>R.lat),te=(Math.max(...Q)-Math.min(...Q))*z/m,G=(Math.max(...X)-Math.min(...X))*D/m,W=Math.max(2,Math.round(Math.min(te,G)*.25));return{cx:Math.max(W,Math.min(u-1-W,V)),cy:Math.max(W,Math.min(b-1-W,ee)),radius:W}}function f(){const e=n.getParams(),u=B(e),b=e.measures||{},m=(i||[]).slice(0,12).map(w=>`${w.lon.toFixed(5)}:${w.lat.toFixed(5)}`).join("|");return`${s?`${s.nx}x${s.ny}@${Math.round(s.dx)}`:"nogrid"}|v=${e.volumeM3}|d=${e.durationS}|m=${u}|ml=${$(b.level).toFixed(2)}|mp=${b.pump?1:0}|md=${b.dike?1:0}|mr=${b.retention?1:0}|p=${m}`}function O(e,u,b,m,v,w,P){return new Promise(L=>{const D=()=>L(fe(e,u,b,m,v,w,P));typeof window.requestIdleCallback=="function"?window.requestIdleCallback(D,{timeout:250}):setTimeout(D,0)})}async function _(){cancelAnimationFrame(g),g=null,h("results"),n.setProgress(null),n.setStatus("Berechne betroffene Gebäude…","bi-buildings");try{const{nx:e,ny:u,dx:b,originLon:m,originLat:v}=s,w=new Float32Array(l.buffer,t.hPtr(),e*u),P=d(),L=f(),D=P?ge(P):0;let z=S.get(L);if(!z&&(z=P?await O(P,w,e,u,b,m,v):[],S.set(L,z),S.size>A)){const V=S.keys().next().value;S.delete(V)}n.setImpact(z),D===0?n.setStatus("Fertig · keine LoD2-Gebäudelayer geladen (Impact = 0)","bi-info-circle"):n.setStatus(`Fertig · ${z.length} Gebäude betroffen`,"bi-check-circle")}catch(e){o("Impact analysis failed:",e),n.setStatus("Simulation beendet (Impact-Analyse fehlgeschlagen)","bi-exclamation-triangle")}}function Z(){if(c!=="running"||!s)return;const e=n.getParams(),u=B(e),b=j(u),m=e.measures||{},v=$(m.level),{nx:w,ny:P,dx:L,originLon:D,originLat:z}=s,V=t.maxDepth(),ee=Number.isFinite(V)&&V>0?Math.min(V,10):.01,Q=Math.max(.01,ee),X=Math.min(L/Math.sqrt(9.81*Q)*.45,4),te=Math.max(1,Math.round(e.speed));let G=null,W=0;if(i&&i.length>=3){G=K(i,w,P,L,D,z);const Ce=Math.max(1,Math.PI*G.radius*G.radius)*L*L,we=e.volumeM3/Math.max(1,e.durationS),Me=Math.max(.2,1-(m.pump?.35*v:0)-(m.retention?.25*v:0)-(m.dike?.1*v:0)),Se=we*b.inflow*Me;W=Math.max(0,Math.min(.01,Se/Ce*X))}const R=1+(m.dike?.55*v:0)+(m.retention?.35*v:0)+(m.pump?.15*v:0),Y=Math.max(.01,.025*b.friction*R);for(let ie=0;ie<te&&(G&&t.injectSource(G.cx,G.cy,G.radius,W),t.step(X,9.81,Y),C+=X,!(C>=e.durationS));ie++);I+=1,I%2===0&&(T(),y==null||y.update(l.buffer,t.hPtr(),t.zbPtr(),w,P,L,D,z));const ne=t.maxDepth(),xe=Number.isFinite(ne)&&ne>=0?Math.min(ne,99):0;if(n.setProgress(Math.min(1,C/e.durationS)),n.setStatus(`T = ${Math.round(C)}s · max. Tiefe ${xe.toFixed(2)} m`,"bi-droplet-fill"),C>=e.durationS){_();return}g=requestAnimationFrame(Z)}n.onDraw(async()=>{if(c==="drawing"){p==null||p.destroy(),p=null,h("idle"),n.setStatus("Zeichnung abgebrochen.","bi-x-circle");return}if(!["idle","ready","results"].includes(c)||!E())return;if(M()!=="3D"&&!await x()){n.setStatus("Bitte zuerst in den 3D-Modus wechseln.","bi-exclamation-triangle");return}const e=d();if(!e){n.setStatus("3D-Modus aktivieren und Polygon zeichnen…","bi-pencil-square");return}h("drawing"),n.setStatus("Klicken = Punkt setzen · Doppelklick = Fertig · Rechtsklick = Fertig/Abbruch","bi-pencil-square"),p=re(e,async u=>{p=null,i=u,await U(e)})}),n.onRun(()=>{if(!E()||!s||!t||!["ready","paused"].includes(c))return;if(c==="ready"){C=0,t.reset();const{heights:b,nx:m,ny:v}=s,w=t.scratchPtr();new Float32Array(l.buffer,w,m*v).set(b),t.setTerrain(w,m*v)}const e=B(n.getParams()),u=e==="flash"?"Sturzflut":e==="river"?"Fluss":"Starkregen";h("running"),n.setStatus(`Simulation läuft… (${u})`,"bi-play-fill"),cancelAnimationFrame(g),g=requestAnimationFrame(Z)}),n.onPause(()=>{c==="running"&&(cancelAnimationFrame(g),g=null,h("paused"),n.setStatus(`Pausiert bei T=${Math.round(C)}s`,"bi-pause-fill"))}),n.onReset(()=>{cancelAnimationFrame(g),g=null,p==null||p.destroy(),p=null,y==null||y.clear(),t.reset(),i=null,s=null,C=0,h("idle"),n.setStatus("",""),n.setProgress(null),n.setImpact([])}),h("idle"),E();const J=setInterval(E,800);window.HydroSim={getState:()=>c,getTerrain:()=>s,getWasm:()=>t,getScene:d,stop:()=>{cancelAnimationFrame(g),g=null,h("paused")},destroy:()=>{clearInterval(J)}}})()})();
